...
| Real number | A real number is a point on the number line; a real number is an equivalence class of Cauchy sequences; a real number is the limit of a Cauchy sequence; a real number is the limit of a sequence of rational numbers under the Cauchy definition of convergence (we can think of the Cauchy definition of convergence as one of many definitions of convergence, along with the epsilon-delta definition for functions and the epsilon-N definition for sequences) |
